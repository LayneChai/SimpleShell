...
- 点击左上角设置弹出AI大模型配置，配置AI大模型
![AI小助手启动](docs/images/AI小助手启动.png)

- 配置完成并且链接服务器之后，点击命令行输入框左边的AI按钮，输入想查询的问题，自动生成常见的命令供你选择
![AI生成结果](docs/images/AI生成结果.png)

- 点击填入命令即可

### 4. 调节透明度

点击窗口左上角的“设置”->“透明度”按钮，可以调节应用背景透明度。
